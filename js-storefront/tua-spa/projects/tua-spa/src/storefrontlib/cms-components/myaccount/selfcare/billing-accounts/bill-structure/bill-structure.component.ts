...
@Component({
  selector: 'cx-bill-structure',
  templateUrl: './bill-structure.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'content-wrapper' }
})
export class BillStructureComponent {
  readonly domainType = BILLING_ACCOUNTS.BILL_STRUCTURE_DOMAIN_TYPE;
