...
/**
 * This is the extension manager of the Tiger extension.
 */
public class TigerManager extends GeneratedTigerManager
{
	 ...
	 */
	public static TigerManager getInstance()
	{
		return (TigerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TigerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TigerManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TigerManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TigerManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TigerManager called, current tenant: " + getTenant().getTenantID());
		}
	}
