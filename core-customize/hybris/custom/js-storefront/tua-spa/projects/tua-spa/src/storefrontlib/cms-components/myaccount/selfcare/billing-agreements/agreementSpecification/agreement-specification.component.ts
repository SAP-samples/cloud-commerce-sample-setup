...
@Component({
  selector: 'cx-agreement-specification',
  templateUrl: 'agreement-specification.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'content-wrapper' }
})
export class AgreementSpecificationComponent{
  readonly domainType = BILLING_AGREEMENTS.AGREEMENT_SPECIFICATION_DOMAIN_TYPE;
