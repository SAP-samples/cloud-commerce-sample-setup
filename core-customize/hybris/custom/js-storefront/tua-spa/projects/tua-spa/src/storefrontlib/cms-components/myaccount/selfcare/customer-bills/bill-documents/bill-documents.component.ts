...
@Component({
    selector: 'cx-selfcare-bill-document',
    templateUrl: './bill-documents.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    host: { class: 'content-wrapper' }
})
export class BillDocumentComponent {
    readonly domainType = CUSTOMER_BILLS.BILL_DOCUMENT_DOMAIN_TYPE;
