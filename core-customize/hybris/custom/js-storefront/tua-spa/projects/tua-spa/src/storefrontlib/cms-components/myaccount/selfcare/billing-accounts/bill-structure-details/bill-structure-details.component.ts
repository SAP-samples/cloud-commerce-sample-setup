...
@Component({
  selector: 'cx-bill-structure-details',
  templateUrl: './bill-structure-details.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'content-wrapper' }
})
export class BillStructureDetailsComponent {
  readonly domainType = BILLING_ACCOUNTS.BILL_STRUCTURE_DETAILS_DOMAIN_TYPE;
